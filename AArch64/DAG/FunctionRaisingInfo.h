...
#ifndef LLVM_TOOLS_LLVM_MCTOLL_AARCH64_DAG_FUNCTIONRAISERINGINFO_H
#define LLVM_TOOLS_LLVM_MCTOLL_AARCH64_DAG_FUNCTIONRAISERINGINFO_H
...
class AArch64FunctionRaisingInfo : public FunctionLoweringInfo {
public:
  ...
  /// Record the latest value of AArch64::R0, if the current function has return
  /// value.
  ...
  void set(AArch64ModuleRaiser &mr, Function &fn, MachineFunction &mf,
           SelectionDAG *DAG);
...
#endif // LLVM_TOOLS_LLVM_MCTOLL_AARCH64_DAG_FUNCTIONRAISERINGINFO_H
