...
#ifndef LLVM_TOOLS_LLVM_MCTOLL_ARM_AARCH64MODULERAISER_H
#define LLVM_TOOLS_LLVM_MCTOLL_ARM_AARCH64MODULERAISER_H

#include "ModuleRaiser.h"

using namespace llvm;

class AArch64ModuleRaiser : public ModuleRaiser {
public:
  static bool classof(const ModuleRaiser *mr) {
    return mr->getArch() == Triple::aarch64;
  }
  AArch64ModuleRaiser() : ModuleRaiser() { Arch = Triple::aarch64; }
...
#endif // LLVM_TOOLS_LLVM_MCTOLL_ARM_AARCH64MODULERAISER_H
